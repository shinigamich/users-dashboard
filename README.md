...
Я выбрал стек Vite + React + TypeScript. Для этой задачи Next.js не дает заметного преимущества, данные публичные, SEO не является ключевой целью, а Vite быстрее и проще для небольшого интерактивного dashboard.
...
Визуально интерфейс сделан спокойным: светлый фон, контрастные акценты, простые контролы и короткие анимации. Dashboard должен выглядеть современно, но не отвлекать от основной задачи: найти человека и посмотреть его данные.

### Начало страницы

![Dashboard](./users-dashboard/src/assets/first.png)

### Пользователи

![Dashboard](./users-dashboard/src/assets/second.png)

### Поиск

![Dashboard](./users-dashboard/src/assets/third.png)
